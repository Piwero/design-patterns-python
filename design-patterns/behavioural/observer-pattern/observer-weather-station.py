...
def weather_station():
    ...
    current_display = CurrentConditionsDisplay(weather_data)  # noqa
    statistics_display = StatisticsDisplay(weather_data)  # noqa
    forecast_display = ForecastDisplay(weather_data)
    heat_index_display = HeatIndexDisplay(weather_data)  # noqa
